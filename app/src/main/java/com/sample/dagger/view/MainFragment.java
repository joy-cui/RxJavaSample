...
import com.sample.dagger.component.MainFragmentComponent;
import com.sample.dagger.presenter.MainPresenter;
import com.sample.dagger.util.MultiConstruct;
import com.sample.dagger.util.ToastUtil;
import com.sample.dagger.view.base.BaseFragment;
...
public class MainFragment extends BaseFragment implements MainPresenter.IUserView{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(getActivity() instanceof DaggerMainActivity){
            mainFragmentComponent = ((DaggerMainActivity)getActivity() ).getMainComponent().mainFragmentComponent();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dagger_fragment_main, container, false);
